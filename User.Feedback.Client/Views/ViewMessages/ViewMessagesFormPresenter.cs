...
namespace User.Feedback.Client.Views.ViewMessages
{
    ...
    {
        public IViewMessagesForm View { get; private set; }

        private IUserFeedbackManager UserFeedbackManager { get; set; }

        public ViewMessagesFormPresenter(IViewMessagesForm view)
            : this(view, BusinessObjects.UserFeedbackManager.Instance)
        {
        }
